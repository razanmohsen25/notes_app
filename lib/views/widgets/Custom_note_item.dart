          ...
          children: [
            ListTile(
              ...
              subtitle: Padding(
                ...
                child: Text('Build your career with razan samy',style: TextStyle(color:Colors.black.withOpacity(.5),fontSize: 18),),
              ),
              trailing: IconButton(onPressed: (){}, icon: Icon(FontAwesomeIcons.trash,size: 25,),
                color: Colors.black,),
